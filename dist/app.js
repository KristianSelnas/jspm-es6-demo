    ...
    return {
      ...
      execute: function() {
        SearchQuery = (function() {
          function SearchQuery(searchString, maxHits) {
            if (maxHits === void 0) {
              maxHits = 10;
            }
        ...
        exports_1("SearchQuery", SearchQuery);
        ...
        exports_1("default", SearchService);
      }
    };
  });
})("file:///Users/johhar/Projects/jspmdemo/app/search/search-service.ts");

(function(__moduleName) {
  $__System.register("10", ["f"], function(exports_1) {
    var search_service_1;
    var GlobalSearchController;
    return {
      setters: [function(search_service_1_1) {
        search_service_1 = search_service_1_1;
      }],
      execute: function() {
        GlobalSearchController = (function() {
          function GlobalSearchController(searchService) {
            this.searchService = searchService;
            this.searchResults = [];
          }
          GlobalSearchController.prototype.search = function() {
            var _this = this;
            this.searchService.search(new search_service_1.SearchQuery(this.searchQuery, this.maxHits)).then(function(res) {
              _this.searchResults = res;
            });
          };
          return GlobalSearchController;
        })();
        exports_1("GlobalSearchController", GlobalSearchController);
...
})("file:///Users/johhar/Projects/jspmdemo/app/search/search.ts");

(function(__moduleName) {
  $__System.register("11", [], function(exports_1) {
...
})("file:///Users/johhar/Projects/jspmdemo/app/search/search-config.ts");

(function(__moduleName) {
  $__System.register("12", ["8", "e", "10", "f", "11"], function(exports_1) {
    var angular,
        angular_ui_router_1,
        search_1,
        search_service_1,
    ...
    return {
      setters: [function(angular_1) {
        ...
        search_service_1 = search_service_1_1;
      }, function(search_config_1_1) {
        search_config_1 = search_config_1_1;
      }],
      execute: function() {
        exports_1("default", name = "app.search");
        module = angular.module(name, [angular_ui_router_1.default]);
        module.config(search_config_1.routes).directive("wbSearch", search_1.default).service("searchService", search_service_1.default);
      }
    };
  });
})("file:///Users/johhar/Projects/jspmdemo/app/search/search-module.ts");

(function(__moduleName) {
  $__System.register("13", [], function(exports_1) {
    ...
    return {
      ...
      execute: function() {
        ...
        exports_1("LayoutController", LayoutController);
        exports_1("default", function() {
          return {
            scope: {},
...
})("file:///Users/johhar/Projects/jspmdemo/app/layout/layout.ts");

(function(__moduleName) {
  $__System.register("14", [], function(exports_1) {
    ...
    return {
      ...
      execute: function() {
        HeaderController = (function() {
          ...
          HeaderController.prototype.search = function(query) {
...
})("file:///Users/johhar/Projects/jspmdemo/app/layout/header.ts");

(function(__moduleName) {
  $__System.register("15", ["8", "12", "13", "14"], function(exports_1) {
    var angular,
        search_module_1,
        layout_1,
        header_1;
    ...
    return {
      ...
      execute: function() {
        exports_1("default", name = "app.layout");
        module = angular.module(name, [search_module_1.default]);
        module.directive("demoLayout", layout_1.default).directive("demoHeader", header_1.default);
      }
    };
  });
})("file:///Users/johhar/Projects/jspmdemo/app/layout/layout-module.ts");
...
})("file:///Users/johhar/Projects/jspmdemo/app/whiteboard/whiteboard-config.ts");
...
(function(__moduleName) {
  $__System.register("17", [], function(exports_1) {
    ...
    return {
      setters: [],
      execute: function() {
        exports_1("NOTE_ADDED", NOTE_ADDED = "note:noteAdded");
        exports_1("NOTE_UPDATED", NOTE_UPDATED = "note:noteUpdated");
        exports_1("NOTE_DELETED", NOTE_DELETED = "note:noteDeleted");
      }
    };
  });
})("file:///Users/johhar/Projects/jspmdemo/app/notes/note-events.ts");
...
(function(__moduleName) {
  $__System.register("18", ["17"], function(exports_1) {
    ...
    return {
      setters: [function(noteEvents_1) {
        noteEvents = noteEvents_1;
      }],
      execute: function() {
        WhiteboardController = (function() {
          function WhiteboardController(notesService, $rootScope) {
            var _this = this;
            this.notesService = notesService;
            this.$rootScope = $rootScope;
            this.notes = [];
            this.notesService.getNotes().then(function(n) {
              return _this.notes = n;
            });
            this.$rootScope.$on(noteEvents.NOTE_ADDED, function(e, note) {
              return _this.onNoteAdded(note);
            });
            this.$rootScope.$on(noteEvents.NOTE_UPDATED, function(e, note) {
              return _this.onNoteUpdated(note);
            });
            this.$rootScope.$on(noteEvents.NOTE_DELETED, function(e, note) {
              return _this.onNoteDeleted(note);
            });
          }
          WhiteboardController.prototype.onNoteAdded = function(note) {
            this.notes.push(note);
          };
          WhiteboardController.prototype.onNoteUpdated = function(note) {
            this.notes.splice(this.getIndex(note), 1, note);
          };
          WhiteboardController.prototype.onNoteDeleted = function(note) {
            this.notes.splice(this.getIndex(note), 1);
          };
          WhiteboardController.prototype.getIndex = function(note) {
            return this.notes.findIndex(function(n) {
              return n.getId() == note.getId();
            });
          };
          ;
          return WhiteboardController;
        })();
        exports_1("WhiteboardController", WhiteboardController);
        exports_1("default", function() {
          return {
            scope: {},
...
})("file:///Users/johhar/Projects/jspmdemo/app/whiteboard/whiteboard.ts");

(function(__moduleName) {
  $__System.register("19", [], function(exports_1) {
    function routes($stateProvider) {
      $stateProvider.state("whiteboard.note", {
        url: "note/edit?id",
        views: {"note-edit": {template: "<wb-note-edit></wb-note-edit>"}}
      });
    }
    exports_1("routes", routes);
    return {
...
})("file:///Users/johhar/Projects/jspmdemo/app/notes/notes-config.ts");

(function(__moduleName) {
  $__System.register("1a", ["17"], function(exports_1) {
    var noteEvents;
    var NoteController;
    return {
      setters: [function(noteEvents_1) {
      ...
      execute: function() {
        NoteController = (function() {
          function NoteController(notesService, $scope) {
            this.notesService = notesService;
            this.$scope = $scope;
          }
          NoteController.prototype.deleteNote = function() {
            var _this = this;
            this.notesService.deleteNote(this.note.getId()).then(function(success) {
              if (success) {
                _this.$scope.$emit(noteEvents.NOTE_DELETED, _this.note);
              }
            });
          };
...
})("file:///Users/johhar/Projects/jspmdemo/app/notes/note.ts");
...
(function(__moduleName) {
  $__System.register("1b", [], function(exports_1) {
    ...
    return {
      ...
      execute: function() {
        Note = (function() {
          function Note(title, text, color, id) {
            if (color === void 0) {
              color = "color1";
            }
            if (id === void 0) {
          ...
          Note.prototype.asJson = function() {
            return {
              "id": this.id,
              "title": this.title,
              "text": this.text,
        ...
        NotesService = (function() {
          function NotesService($http) {
            this.$http = $http;
            this.apiUrl = "http://localhost:8081/api/notes";
          }
          NotesService.prototype.getNotes = function() {
            return this.$http.get(this.apiUrl).then(function(res) {
          ...
          NotesService.prototype.addNote = function(note) {
            return this.$http.post(this.apiUrl, note.asJson()).then(function(res) {
              return Note.fromJson(res.data);
            });
          };
          NotesService.prototype.updateNote = function(note) {
            return this.$http.put(this.apiUrl + "/" + note.getId(), note.asJson()).then(function(res) {
              return Note.fromJson(res.data);
            });
          };
          NotesService.prototype.getNote = function(noteId) {
            return this.$http.get(this.apiUrl + "/" + noteId).then(function(res) {
              return Note.fromJson(res.data);
            });
          };
          NotesService.prototype.deleteNote = function(noteId) {
            return this.$http.delete(this.apiUrl + "/" + noteId).success(function() {
              return true;
            }).error(function() {
              return false;
            });
        ...
        exports_1("default", NotesService);
      }
    };
  });
})("file:///Users/johhar/Projects/jspmdemo/app/notes/notes-service.ts");

(function(__moduleName) {
  $__System.register("1c", ["1b", "17"], function(exports_1) {
    var notes_service_1,
        noteEvents;
    var NoteEditController;
    return {
      setters: [function(notes_service_1_1) {
        notes_service_1 = notes_service_1_1;
      }, function(noteEvents_1) {
        noteEvents = noteEvents_1;
      }],
      execute: function() {
        NoteEditController = (function() {
          function NoteEditController(notesService, $state, $scope, $stateParams) {
            var _this = this;
            this.notesService = notesService;
            this.$state = $state;
            this.$scope = $scope;
            ...
            if (noteId) {
              notesService.getNote(noteId).then(function(note) {
                return _this.note = note;
              });
            } else {
              this.note = new notes_service_1.Note();
            }
          }
          NoteEditController.prototype.saveOrUpdate = function() {
            var _this = this;
            if (this.note.isNew()) {
              this.notesService.addNote(this.note).then(function(newNote) {
                _this.$scope.$emit(noteEvents.NOTE_ADDED, newNote);
                _this.$state.go("whiteboard");
              });
            } else {
              this.notesService.updateNote(this.note).then(function(updatedNote) {
                _this.$scope.$emit(noteEvents.NOTE_UPDATED, updatedNote);
                _this.$state.go("whiteboard");
              });
            }
          };
        ...
        exports_1("NoteEditController", NoteEditController);
        exports_1("default", function() {
          return {
            scope: {note: "="},
...
})("file:///Users/johhar/Projects/jspmdemo/app/notes/note-edit.ts");

(function(__moduleName) {
  $__System.register("1d", ["8", "e", "19", "1a", "1c", "1b"], function(exports_1) {
    var angular,
        angular_ui_router_1,
        notes_config_1,
        note_1,
    ...
    return {
      setters: [function(angular_1) {
        ...
        angular_ui_router_1 = angular_ui_router_1_1;
      }, function(notes_config_1_1) {
        notes_config_1 = notes_config_1_1;
      }, function(note_1_1) {
        note_1 = note_1_1;
      }, function(note_edit_1_1) {
        note_edit_1 = note_edit_1_1;
      }, function(notes_service_1_1) {
        notes_service_1 = notes_service_1_1;
      }],
      execute: function() {
        exports_1("default", name = "app.notes");
        module = angular.module(name, [angular_ui_router_1.default]);
        module.config(notes_config_1.routes).directive("wbNote", note_1.default).directive("wbNoteEdit", note_edit_1.default).service("notesService", notes_service_1.default);
      }
    };
  });
})("file:///Users/johhar/Projects/jspmdemo/app/notes/notes-module.ts");

(function(__moduleName) {
  $__System.register("1e", ["8", "e", "16", "18", "1d"], function(exports_1) {
    var angular,
        angular_ui_router_1,
        whiteboard_config_1,
        whiteboard_1,
    ...
    return {
      setters: [function(angular_1) {
        ...
        angular_ui_router_1 = angular_ui_router_1_1;
      }, function(whiteboard_config_1_1) {
        whiteboard_config_1 = whiteboard_config_1_1;
      }, function(whiteboard_1_1) {
        whiteboard_1 = whiteboard_1_1;
      }, function(notes_module_1_1) {
        notes_module_1 = notes_module_1_1;
      }],
      execute: function() {
        exports_1("default", name = "app.whiteboard");
        module = angular.module(name, [angular_ui_router_1.default, notes_module_1.default]);
        module.config(whiteboard_config_1.routes).directive("wbWhiteboard", whiteboard_1.default);
      }
    };
  });
})("file:///Users/johhar/Projects/jspmdemo/app/whiteboard/whiteboard-module.ts");

(function(__moduleName) {
  $__System.register("1", ["8", "15", "1e"], function(exports_1) {
    var angular,
        layout_module_1,
        whiteboard_module_1;
    var module;
    return {
      ...
      }, function(whiteboard_module_1_1) {
        whiteboard_module_1 = whiteboard_module_1_1;
      }],
      execute: function() {
        exports_1("default", name = "app");
        module = angular.module(name, [layout_module_1.default, whiteboard_module_1.default]);
...
})("file:///Users/johhar/Projects/jspmdemo/app/app.ts");
